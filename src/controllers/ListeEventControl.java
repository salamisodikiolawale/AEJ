...
public class ListeEventControl implements Initializable{
	 ...
	 @FXML
	    ...
	    @FXML
	    private TableColumn<String, String> idTabView;

	    @FXML
	    private TableColumn<String, String> PlanteTabView;

	    @FXML
	    private TableColumn<String, String> ActiviteTabView;

	    @FXML
	    private TableColumn<String, String> dateTabView;

	    @FXML
	    private TableColumn<String, String> noteTabView;
	    
	    ObservableList<Events> eventFxc = FXCollections.observableArrayList();
